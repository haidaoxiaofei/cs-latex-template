...
\begin{figure}[ht!]\centering \figureTopMargin\vspace{1ex}
	\subfigure[][{\scriptsize Sub Caption1}]{
		\scalebox{0.19}[0.19]{\includegraphics{../figures/example1.eps}}
...
\begin{figure}[h!]\centering 
	\subfigure{
		\scalebox{0.4}[0.4]{\includegraphics{../figures/bar.eps}}}\hfill\\\vspace{-2ex}
	\addtocounter{subfigure}{-1}
	\subfigure[][{\scriptsize Sub Caption1}]{
		\scalebox{0.19}[0.19]{\includegraphics{../figures/example.eps}}
...
Some suggestions/lessons noticed from helping junior PhD student to revise drafts:
\begin{itemize}[leftmargin=*]
